...
import CoolInfoSection from '@/components/ui/coolInfoSection'
import {NavigationLayout} from '@/components/Navigation'

export default function CoolThemes() {
    // 状态管理
    ...
    // 主题选项
    const themes = [
        {id: 'aurora', name: 'Aurora', image: '/images/Aurora.webp'},
        {id: 'deepocean', name: 'Deep Ocean', image: '/images/DeepOcean.webp'},
        {id: 'starfield', name: 'Starfield', image: '/images/Starfield.webp'},
        {id: 'nebula', name: 'Nebula', image: '/images/Nebula.webp'},
        {id: 'fireworks', name: 'Fireworks', image: '/images/Fireworks.webp'},
        {id: 'wave', name: 'Wave', image: '/images/Wave.webp'}
    ]

    // 模拟字典对象（实际项目中应该从i18n获取）
    const dictionary = {
        colorSelector: {
            title: 'Select Color',
            custom: 'Custom'
            ...
            <main className="pt-0 pb-2 min-h-screen mx-auto px-4 md:px-6 bg-[#000000cc]">
                <div className="max-w-content mx-auto px-6">
                    <section className="mb-10">
                        <div className="text-center mb-12 pt-8">
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">
                                <span className="text-[#3A6FF8]">Cool</span> Themes
                            </h1>
                            <h2 className="text-2xl md:text-3xl font-semibold text-white mb-6">
                                Stunning themes to make every fullscreen experience unique
                            </h2>
                            <p className="text-[#B0B3B8] text-center mb-8 max-w-2xl mx-auto leading-relaxed">
                                BlackScreen themes bring inspiration to your screen, whether for relaxation, focus, or creative work. 
                                Press <kbd className="px-2 py-1 bg-[#1A1A1A] rounded-md text-sm border border-[#3A6FF8]/30">Space</kbd> for fullscreen, 
                                or <kbd className="px-2 py-1 bg-[#1A1A1A] rounded-md text-sm border border-[#3A6FF8]/30">ESC</kbd> to exit anytime.
                            </p>
                        </div>

                        <div className="flex flex-col items-center gap-10">
                            <div
                                className="w-full max-w-4xl backdrop-blur-sm bg-black/30 rounded-2xl p-6 border border-[#3A6FF8]/10 shadow-lg">
                    ...
                    <div className="max-w-5xl mx-auto mt-10">
                        <CoolInfoSection dictionary={dictionary} />
                    </div>
                </div>
            </main>
        </NavigationLayout>
